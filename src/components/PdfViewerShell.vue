  ...
  <q-card bordered class="pdf-viewer-shell">
    <q-toolbar class="pdf-viewer-shell__toolbar" dense>
      ...
      <q-btn
        ...
        @click="zoomOut"
      />
      <q-btn flat dense class="pdf-viewer-shell__zoom-button" :disable="!hasDocument">
        {{ zoomDisplayValue }}
...
.pdf-viewer-shell__toolbar :deep(.q-separator--vertical) {
  height: 28px;
  opacity: 0.35;
  margin: 0 8px;
}

.pdf-viewer-shell__title {
  flex: 0 0 auto;
  min-width: 140px;
}

.pdf-viewer-shell__zoom-button {
